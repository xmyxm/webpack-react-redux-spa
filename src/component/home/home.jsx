...
class Home extends Component{
	...
	componentDidMount(){
		...
		this.props.fetchPosts('http://qqweb.top/API/BlogApi/WorkList',{PageIndex:1,PageSize:10});
		//this.props.fetchPosts('http://localhost:51972/API/BlogApi/WorkList',{PageIndex:1,PageSize:10});
