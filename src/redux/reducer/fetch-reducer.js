...
const defaultlState = {'Json': {},'istrue':false, 'isFetching': false,'page':0,'pageSize':10};
//首次渲染时获取数据
const fetchData = (state = defaultlState , action = {}) => {
    switch(action.type){
        case REQUEST_POSTS:
            return {'Json':{},'isFetching':true,'param':action.param,'page':action.page,'pageSize':action.pageSize};
